...
// Config is to configs the parameters of BDLS consensus protocol
type Config struct {
	...
	// Usually this will lead to block header comparison in blockchain, or replication log in database,
	...
	// Identity derivation from ecdsa.PublicKey
	// (optional). Default to DefaultPubKeyToIdentity
	PubKeyToIdentity func(pubkey *ecdsa.PublicKey) (ret Identity)
}

// VerifyConfig verifies the integrity of this configs when creating new consensus object
