...
const (
	...
	//其余节点向Leader发送的共识信息
	MessageType_ConsensusInfo MessageType = 8
	//向上级请求共识
	MessageType_RequestConsensus MessageType = 9
	//上级同意共识
	MessageType_AgreeConsensus MessageType = 10
	//其余节点向leader发送待共识区块信息
	MessageType_BlocksInfo MessageType = 11
)
